...
solver. For each Newton iteration, we apply the direct linear solver MUMPS.
The goal is to evaluate the performance of the direct solver, which will serve
as a reference for measuring the speed-up achieved when using iterative linear
solvers.
"""
from dolfin import *
import numpy as np
...
nonlinear_solver.parameters["linear_solver"] = 'mumps'
